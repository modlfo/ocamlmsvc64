...
# default setttings
SWITCH=${OPAM_SWITCH:-'4.06.0+flambda+msvc64'}
...
eval $(opam config env --root "C:\\ocaml")
opam install pla containers ppx_deriving ounit menhir yojson merlin qtest jbuilder ocaml-migrate-parsetree ocp-indent --root "C:\\ocaml"
